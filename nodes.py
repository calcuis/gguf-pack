...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    # for gguf
    "LoaderGGUF": "GGUF Loader",
    "ClipLoaderGGUF": "GGUF CLIP Loader",
    "DualClipLoaderGGUF": "GGUF DualCLIP Loader",
    "TripleClipLoaderGGUF": "GGUF TripleCLIP Loader",
    "LoaderGGUFAdvanced": "GGUF Loader (Advanced)",
    "VaeGGUF": "GGUF VAE Loader",
    "GGUFUndo": "GGUF Convertor (Reverse)",
